  ...
  return (
    ...
    >
      <rect
        ...
        height="16"
        rx="3"
        className={`fill-[#2B2939] transition-all group-hover/native:fill-washed-blue-500`}
      />
      <path
        ...
        className={`fill-[#817EB5] text-xl transition-all group-hover/native:fill-washed-purple-400`}
      />
    </svg>
  );
};
